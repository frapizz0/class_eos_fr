...
double H0 = pba->H0;
double HSb,fR0,Om0,Ol,Or0,w_fR,rho_fR,l,b, N;
  	...
  	if (l == 0){		//lcdm
    	...
    	if (l > 0){
    		if (l == 1){
   			...
   			b = (Ol*(-Ol - 3.0*Om0*fR0 + 3.0*Om0 + 4.0*Or0*fR0 - 4.0*Or0 - 4.0*fR0 + 4.0) - sqrt(pow(Ol, 3)*(Ol + 6.0*Om0*fR0 - 6.0*Om0 - 8.0*Or0*fR0 + 8.0*Or0 + 8.0*fR0 - 8.0)))/(pow(Ol, 2)*(fR0 - 1.0));
   			//dark matter state equation
   			w_fR = (12288*pow(Ol, 9)*pow(b, 2)*exp(27*N) + 294912*pow(Ol, 9)*b*exp(27*N) - 786432*pow(Ol, 9)*exp(27*N) + 27648*pow(Ol, 8)*Om0*pow(b, 2)*exp(24*N) + 663552*pow(Ol, 8)*Om0*b*exp(24*N) - 1769472*pow(Ol, 8)*Om0*exp(24*N) + 12288*pow(Ol, 8)*Or0*pow(b, 2)*exp(23*N) + 32768*pow(Ol, 8)*Or0*b*exp(23*N) + 52992*pow(Ol, 7)*pow(Om0, 2)*pow(b, 2)*exp(21*N) + 645120*pow(Ol, 7)*pow(Om0, 2)*b*exp(21*N) - 1769472*pow(Ol, 7)*pow(Om0, 2)*exp(21*N) - 37888*pow(Ol, 7)*Om0*Or0*pow(b, 2)*exp(20*N) + 204800*pow(Ol, 7)*Om0*Or0*b*exp(20*N) + 129984*pow(Ol, 6)*pow(Om0, 3)*pow(b, 2)*exp(18*N) + 271872*pow(Ol, 6)*pow(Om0, 3)*b*exp(18*N) - 1032192*pow(Ol, 6)*pow(Om0, 3)*exp(18*N) + 575488*pow(Ol, 6)*pow(Om0, 2)*Or0*pow(b, 2)*exp(17*N) + 153600*pow(Ol, 6)*pow(Om0, 2)*Or0*b*exp(17*N) - 294912*pow(Ol, 6)*Om0*pow(Or0, 2)*pow(b, 2)*exp(16*N) - 189072*pow(Ol, 5)*pow(Om0, 4)*pow(b, 2)*exp(15*N) + 17280*pow(Ol, 5)*pow(Om0, 4)*b*exp(15*N) - 387072*pow(Ol, 5)*pow(Om0, 4)*exp(15*N) + 654848*pow(Ol, 5)*pow(Om0, 3)*Or0*pow(b, 2)*exp(14*N) + 17920*pow(Ol, 5)*pow(Om0, 3)*Or0*b*exp(14*N) + 933120*pow(Ol, 5)*pow(Om0, 2)*pow(Or0, 2)*pow(b, 2)*exp(13*N) - 335268*pow(Ol, 4)*pow(Om0, 5)*pow(b, 2)*exp(12*N) - 25632*pow(Ol, 4)*pow(Om0, 5)*b*exp(12*N) - 96768*pow(Ol, 4)*pow(Om0, 5)*exp(12*N) - 812176*pow(Ol, 4)*pow(Om0, 4)*Or0*pow(b, 2)*exp(11*N) - 18560*pow(Ol, 4)*pow(Om0, 4)*Or0*b*exp(11*N) - 457920*pow(Ol, 4)*pow(Om0, 3)*pow(Or0, 2)*pow(b, 2)*exp(10*N) + 53652*pow(Ol, 3)*pow(Om0, 6)*pow(b, 2)*exp(9*N) - 9432*pow(Ol, 3)*pow(Om0, 6)*b*exp(9*N) - 16128*pow(Ol, 3)*pow(Om0, 6)*exp(9*N) + 93052*pow(Ol, 3)*pow(Om0, 5)*Or0*pow(b, 2)*exp(8*N) - 7968*pow(Ol, 3)*pow(Om0, 5)*Or0*b*exp(8*N) + 40320*pow(Ol, 3)*pow(Om0, 4)*pow(Or0, 2)*pow(b, 2)*exp(7*N) + 333*pow(Ol, 2)*pow(Om0, 7)*pow(b, 2)*exp(6*N) - 1350*pow(Ol, 2)*pow(Om0, 7)*b*exp(6*N) - 1728*pow(Ol, 2)*pow(Om0, 7)*exp(6*N) + 320*pow(Ol, 2)*pow(Om0, 6)*Or0*pow(b, 2)*exp(5*N) - 1240*pow(Ol, 2)*pow(Om0, 6)*Or0*b*exp(5*N) - 72*Ol*pow(Om0, 8)*b*exp(3*N) - 108*Ol*pow(Om0, 8)*exp(3*N) - 70*Ol*pow(Om0, 7)*Or0*b*exp(2*N) - 3*pow(Om0, 9))/(-12288*pow(Ol, 9)*pow(b, 2)*exp(27*N) - 294912*pow(Ol, 9)*b*exp(27*N) + 786432*pow(Ol, 9)*exp(27*N) + 107520*pow(Ol, 8)*Om0*pow(b, 2)*exp(24*N) - 368640*pow(Ol, 8)*Om0*b*exp(24*N) + 1769472*pow(Ol, 8)*Om0*exp(24*N) + 36864*pow(Ol, 8)*Or0*pow(b, 2)*exp(23*N) + 98304*pow(Ol, 8)*Or0*b*exp(23*N) + 301824*pow(Ol, 7)*pow(Om0, 2)*pow(b, 2)*exp(21*N) - 18432*pow(Ol, 7)*pow(Om0, 2)*b*exp(21*N) + 1769472*pow(Ol, 7)*pow(Om0, 2)*exp(21*N) + 33792*pow(Ol, 7)*Om0*Or0*pow(b, 2)*exp(20*N) + 319488*pow(Ol, 7)*Om0*Or0*b*exp(20*N) + 373440*pow(Ol, 6)*pow(Om0, 3)*pow(b, 2)*exp(18*N) + 198144*pow(Ol, 6)*pow(Om0, 3)*b*exp(18*N) + 1032192*pow(Ol, 6)*pow(Om0, 3)*exp(18*N) + 270336*pow(Ol, 6)*pow(Om0, 2)*Or0*pow(b, 2)*exp(17*N) + 350208*pow(Ol, 6)*pow(Om0, 2)*Or0*b*exp(17*N) - 110592*pow(Ol, 6)*Om0*pow(Or0, 2)*pow(b, 2)*exp(16*N) + 165648*pow(Ol, 5)*pow(Om0, 4)*pow(b, 2)*exp(15*N) + 144000*pow(Ol, 5)*pow(Om0, 4)*b*exp(15*N) + 387072*pow(Ol, 5)*pow(Om0, 4)*exp(15*N) + 374784*pow(Ol, 5)*pow(Om0, 3)*Or0*pow(b, 2)*exp(14*N) + 192000*pow(Ol, 5)*pow(Om0, 3)*Or0*b*exp(14*N) + 186624*pow(Ol, 5)*pow(Om0, 2)*pow(Or0, 2)*pow(b, 2)*exp(13*N) - 33516*pow(Ol, 4)*pow(Om0, 5)*pow(b, 2)*exp(12*N) + 48672*pow(Ol, 4)*pow(Om0, 5)*b*exp(12*N) + 96768*pow(Ol, 4)*pow(Om0, 5)*exp(12*N) - 27120*pow(Ol, 4)*pow(Om0, 4)*Or0*pow(b, 2)*exp(11*N) + 59520*pow(Ol, 4)*pow(Om0, 4)*Or0*b*exp(11*N) + 5184*pow(Ol, 4)*pow(Om0, 3)*pow(Or0, 2)*pow(b, 2)*exp(10*N) - 14412*pow(Ol, 3)*pow(Om0, 6)*pow(b, 2)*exp(9*N) + 9000*pow(Ol, 3)*pow(Om0, 6)*b*exp(9*N) + 16128*pow(Ol, 3)*pow(Om0, 6)*exp(9*N) - 26556*pow(Ol, 3)*pow(Om0, 5)*Or0*pow(b, 2)*exp(8*N) + 10656*pow(Ol, 3)*pow(Om0, 5)*Or0*b*exp(8*N) - 12096*pow(Ol, 3)*pow(Om0, 4)*pow(Or0, 2)*pow(b, 2)*exp(7*N) - 111*pow(Ol, 2)*pow(Om0, 7)*pow(b, 2)*exp(6*N) + 882*pow(Ol, 2)*pow(Om0, 7)*b*exp(6*N) + 1728*pow(Ol, 2)*pow(Om0, 7)*exp(6*N) - 120*pow(Ol, 2)*pow(Om0, 6)*Or0*pow(b, 2)*exp(5*N) + 1032*pow(Ol, 2)*pow(Om0, 6)*Or0*b*exp(5*N) + 36*Ol*pow(Om0, 8)*b*exp(3*N) + 108*Ol*pow(Om0, 8)*exp(3*N) + 42*Ol*pow(Om0, 7)*Or0*b*exp(2*N) + 3*pow(Om0, 9));
   			
   			// dark matter density
   			rho_fR = pow(H0, 2)*Ol*(384.0*pow(Ol, 8)*pow(b, 2)*exp(24*N) + 9216.0*pow(Ol, 8)*b*exp(24*N) - 24576.0*pow(Ol, 8)*exp(24*N) - 3456.0*pow(Ol, 7)*Om0*pow(b, 2)*exp(21*N) + 9216.0*pow(Ol, 7)*Om0*b*exp(21*N) - 49152.0*pow(Ol, 7)*Om0*exp(21*N) - 1152.0*pow(Ol, 7)*Or0*pow(b, 2)*exp(20*N) - 3072.0*pow(Ol, 7)*Or0*b*exp(20*N) - 8568.0*pow(Ol, 6)*pow(Om0, 2)*pow(b, 2)*exp(18*N) - 1728.0*pow(Ol, 6)*pow(Om0, 2)*b*exp(18*N) - 43008.0*pow(Ol, 6)*pow(Om0, 2)*exp(18*N) - 768.0*pow(Ol, 6)*Om0*Or0*pow(b, 2)*exp(17*N) - 9216.0*pow(Ol, 6)*Om0*Or0*b*exp(17*N) - 9528.0*pow(Ol, 5)*pow(Om0, 3)*pow(b, 2)*exp(15*N) - 5760.0*pow(Ol, 5)*pow(Om0, 3)*b*exp(15*N) - 21504.0*pow(Ol, 5)*pow(Om0, 3)*exp(15*N) - 8256.0*pow(Ol, 5)*pow(Om0, 2)*Or0*pow(b, 2)*exp(14*N) - 8640.0*pow(Ol, 5)*pow(Om0, 2)*Or0*b*exp(14*N) + 3456.0*pow(Ol, 5)*Om0*pow(Or0, 2)*pow(b, 2)*exp(13*N) - 2794.5*pow(Ol, 4)*pow(Om0, 4)*pow(b, 2)*exp(12*N) - 3060.0*pow(Ol, 4)*pow(Om0, 4)*b*exp(12*N) - 6720.0*pow(Ol, 4)*pow(Om0, 4)*exp(12*N) - 9648.0*pow(Ol, 4)*pow(Om0, 3)*Or0*pow(b, 2)*exp(11*N) - 3840.0*pow(Ol, 4)*pow(Om0, 3)*Or0*b*exp(11*N) - 6696.0*pow(Ol, 4)*pow(Om0, 2)*pow(Or0, 2)*pow(b, 2)*exp(10*N) + 1746.0*pow(Ol, 3)*pow(Om0, 5)*pow(b, 2)*exp(9*N) - 756.0*pow(Ol, 3)*pow(Om0, 5)*b*exp(9*N) - 1344.0*pow(Ol, 3)*pow(Om0, 5)*exp(9*N) + 3259.5*pow(Ol, 3)*pow(Om0, 4)*Or0*pow(b, 2)*exp(8*N) - 900.0*pow(Ol, 3)*pow(Om0, 4)*Or0*b*exp(8*N) + 1512.0*pow(Ol, 3)*pow(Om0, 3)*pow(Or0, 2)*pow(b, 2)*exp(7*N) + 13.875*pow(Ol, 2)*pow(Om0, 6)*pow(b, 2)*exp(6*N) - 92.25*pow(Ol, 2)*pow(Om0, 6)*b*exp(6*N) - 168.0*pow(Ol, 2)*pow(Om0, 6)*exp(6*N) + 15.0*pow(Ol, 2)*pow(Om0, 5)*Or0*pow(b, 2)*exp(5*N) - 108.0*pow(Ol, 2)*pow(Om0, 5)*Or0*b*exp(5*N) - 4.5*Ol*pow(Om0, 7)*b*exp(3*N) - 12.0*Ol*pow(Om0, 7)*exp(3*N) - 5.25*Ol*pow(Om0, 6)*Or0*b*exp(2*N) - 0.375*pow(Om0, 8))/(65536.0*pow(Ol, 8)*Om0*exp(24*N) + 65536.0*pow(Ol, 8)*Or0*exp(24*N) - 65536.0*pow(Ol, 8)*exp(24*N) + 131072.0*pow(Ol, 7)*pow(Om0, 2)*exp(21*N) + 131072.0*pow(Ol, 7)*Om0*Or0*exp(21*N) - 131072.0*pow(Ol, 7)*Om0*exp(21*N) + 114688.0*pow(Ol, 6)*pow(Om0, 3)*exp(18*N) + 114688.0*pow(Ol, 6)*pow(Om0, 2)*Or0*exp(18*N) - 114688.0*pow(Ol, 6)*pow(Om0, 2)*exp(18*N) + 57344.0*pow(Ol, 5)*pow(Om0, 4)*exp(15*N) + 57344.0*pow(Ol, 5)*pow(Om0, 3)*Or0*exp(15*N) - 57344.0*pow(Ol, 5)*pow(Om0, 3)*exp(15*N) + 17920.0*pow(Ol, 4)*pow(Om0, 5)*exp(12*N) + 17920.0*pow(Ol, 4)*pow(Om0, 4)*Or0*exp(12*N) - 17920.0*pow(Ol, 4)*pow(Om0, 4)*exp(12*N) + 3584.0*pow(Ol, 3)*pow(Om0, 6)*exp(9*N) + 3584.0*pow(Ol, 3)*pow(Om0, 5)*Or0*exp(9*N) - 3584.0*pow(Ol, 3)*pow(Om0, 5)*exp(9*N) + 448.0*pow(Ol, 2)*pow(Om0, 7)*exp(6*N) + 448.0*pow(Ol, 2)*pow(Om0, 6)*Or0*exp(6*N) - 448.0*pow(Ol, 2)*pow(Om0, 6)*exp(6*N) + 32.0*Ol*pow(Om0, 8)*exp(3*N) + 32.0*Ol*pow(Om0, 7)*Or0*exp(3*N) - 32.0*Ol*pow(Om0, 7)*exp(3*N) + 1.0*pow(Om0, 9) + 1.0*pow(Om0, 8)*Or0 - 1.0*pow(Om0, 8));
